 ...
 *
 *     // adds a new person to the phones array
 ...
 *     };
 *
 *     ctrl.addPhone = function(person) {
 *       $http.post('/phones', person).then(function() {
 *         ctrl.newPhone = {name: ''};
 ...
 *   <h1>Phones</h1>
 *   <ul>
 *     <li ng-repeat="person in $ctrl.phones">{{person.name}}</li>
 *   </ul>
 *   </div>
 * </file>
 * </example>
